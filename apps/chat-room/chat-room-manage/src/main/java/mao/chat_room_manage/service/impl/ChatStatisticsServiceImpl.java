 ...
 * Class(类名): ChatStatisticsServiceImpl
 * Author(作者）: mao
...
public class ChatStatisticsServiceImpl implements ChatStatisticsService
{
    ...
    @Override
    public List<Statistics> getRecentMonthChatDayCount()
    {
        //得到当前时间
        ...
        //当天
        String key = RedisConstants.chat_day_count_key + now.getYear() + ":" +
        ...
        for (int i = 1; i < 30; i++)
        {
            ...
            key = RedisConstants.chat_day_count_key + localDate.getYear() + ":" +
    ...
    @Override
    public List<Statistics> getRecentYearChatMonthCount()
    {
        //得到当前时间
        LocalDate now = LocalDate.now();
        ...
        //当天
        String key = RedisConstants.chat_month_count_key + now.getYear() + ":" +
                now.getMonthValue();
        keys.add(key);
        ...
        for (int i = 1; i < 12; i++)
        {
            ...
            key = RedisConstants.chat_month_count_key + localDate.getYear() + ":" +
    ...
    @Override
    public List<Statistics> getChatDayCountList(int startYear, int startMonth, int startDay, int endYear, int endMonth, int endDay)
    {
        ...
        String key = RedisConstants.chat_day_count_key + endDate.getYear() + ":" +
    ...
    @Override
    public List<Statistics> getChatMonthCountList(int startYear, int startMonth, int endYear, int endMonth)
    {
        LocalDateUtils.handlerYear(startYear);
        LocalDateUtils.handlerMonth(startMonth);
        LocalDateUtils.handlerYear(endYear);
        ...
        //当天
        String key = RedisConstants.chat_month_count_key + endDate.getYear() + ":" +
