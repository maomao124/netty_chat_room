 ...
 * Class(类名): GroupCreateStatisticsServiceImpl
 * Author(作者）: mao
 ...
 * Time(创建时间)： 13:34
 * Version(版本): 1.0
 * Description(描述)： 群聊创建统计服务实现类
 */

@Slf4j
@Service
public class GroupCreateStatisticsServiceImpl implements GroupCreateStatisticsService
{
    ...
    public List<Statistics> getRecentMonthGroupChatDayCount()
    {
        ...
        //当天
        String key = RedisConstants.group_create_day_count_key + now.getYear() + ":" +
        ...
        for (int i = 1; i < 30; i++)
        {
            ...
            key = RedisConstants.group_create_day_count_key + localDate.getYear() + ":" +
    ...
    public List<Statistics> getRecentYearGroupChatMonthCount()
    {
        ...
        //当天
        String key = RedisConstants.group_create_month_count_key + now.getYear() + ":" +
                now.getMonthValue();
        keys.add(key);
        ...
        for (int i = 1; i < 12; i++)
        {
            ...
            key = RedisConstants.group_create_month_count_key + localDate.getYear() + ":" +
    ...
    public List<Statistics> getChatDayGroupCountList(int startYear, int startMonth, int startDay, int endYear, int endMonth, int endDay)
    {
        ...
        String key = RedisConstants.group_create_day_count_key + endDate.getYear() + ":" +
    ...
    public List<Statistics> getChatMonthGroupCountList(int startYear, int startMonth, int endYear, int endMonth)
    {
        ...
        //当天
        String key = RedisConstants.group_create_month_count_key + endDate.getYear() + ":" +
