...
public class StatisticsController extends BaseController
{
    ...
    {
        return success(statisticsService.getRecentYearLoginMonthCount());
    }
    ...
    {
        return success(statisticsService.getRecentMonthLoginDayUVCount());
    }
    ...
    {
        return success(statisticsService.getRecentYearLoginMonthUVCount());
    }
}
