 ...
 * Class(类名): GroupChatStatisticsServiceImpl
 * Author(作者）: mao
...
public class GroupChatStatisticsServiceImpl implements GroupChatStatisticsService
{
    ...
    public List<Statistics> getRecentMonthGroupChatDayCount()
    {
        ...
        //当天
        String key = RedisConstants.group_chat_month_count_key + now.getYear() + ":" +
        ...
        for (int i = 1; i < 30; i++)
        {
            ...
            key = RedisConstants.group_chat_day_count_key + localDate.getYear() + ":" +
    ...
    public List<Statistics> getChatDayGroupCountList(int startYear, int startMonth, int startDay, int endYear, int endMonth, int endDay)
    {
        ...
        String key = RedisConstants.group_chat_day_count_key + endDate.getYear() + ":" +
    ...
    public List<Statistics> getChatMonthGroupCountList(int startYear, int startMonth, int endYear, int endMonth)
    {
        ...
        //当天
        String key = RedisConstants.group_chat_month_count_key + endDate.getYear() + ":" +
        ...
        for (int i = 1; i < Math.toIntExact(monthTimeDifference); i++)
        {
            ...
            key = RedisConstants.group_chat_month_count_key + localDate.getYear() + ":" +
                    localDate.getMonthValue();
            keys.add(key);
            times.add(localDate.getYear() + "/" + localDate.getMonthValue());
        }
