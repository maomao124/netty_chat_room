...
public class ChatRoomManageApplication
{
    ...
    (String[] args) throws UnknownHostException
    {
        ...
        //启动
        ConfigurableApplicationContext applicationContext = SpringApplication.run(ChatRoomManageApplication.class, args);
        //环境
