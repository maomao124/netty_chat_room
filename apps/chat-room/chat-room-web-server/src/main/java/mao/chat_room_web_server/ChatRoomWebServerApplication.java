...
public class ChatRoomWebServerApplication
{
    /**
     * 服务启动类
     *
    ...
    (String[] args) throws UnknownHostException
    {
        ...
        //启动
        ConfigurableApplicationContext applicationContext = SpringApplication.run(ChatRoomWebServerApplication.class, args);
        //环境
