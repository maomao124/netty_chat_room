...
public class ChatRoomGatewayApplication
{
    ...
    public static void main(String[] args) throws UnknownHostException
    {
        ...
        //启动
        ConfigurableApplicationContext applicationContext = SpringApplication.run(ChatRoomGatewayApplication.class, args);
        //环境
